...
public class OBJ_AWP extends Projectile implements Weapon{
	GamePanel gp;
	public OBJ_AWP(GamePanel gp) {
		super(gp);
		this.gp = gp;
		name = "AWP";
		speed = 30;
		...
		alive = false;
		description = "[" + name + "]\nAMMO: " + useCost + "/10";	
		icon = setup("/weapons/awp", gp.tileSize, gp.tileSize);
		getImage();
	}
	...
	public int getShootSoundIndex() {
		return 40;  // Índice del sonido de disparo del AWP en tu arreglo de sonidos.
	}

	@Override
	public int getShootHitSoundIndex() {
		return 41;  // Índice del sonido de golpe del AWP en tu arreglo de sonidos.
	}
}
